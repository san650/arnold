...
Define a standalone exercise catalog of reusable definitions that carry identity
only, presented as a single de-duplicated list merged with routine exercise
instances, with safe deletion of unused definitions and definition-level edits
that stay in sync across routines.
## Requirements

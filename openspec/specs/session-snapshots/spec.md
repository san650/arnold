...
Define how session snapshots normalize and preserve historical data: weights
are stored in kg at write time, legacy lb snapshots convert at read time, and
each snapshot freezes the exercise's category.

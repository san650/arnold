# day-analytics Specification

## Purpose

Define the read-only day view opened from the dashboard heatmap: its route,
navigation between trained days, day metrics, muscle-group chips,
routine-grouped exercise list with PR detection and per-routine volume deltas,
and the rest-day state.

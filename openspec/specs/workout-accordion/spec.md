# workout-accordion Specification

## Purpose

Define how the workout screen presents exercise cards as a single-expansion
accordion: what collapsed and expanded cards show, which exercise starts
expanded on entry, how expansion interacts with set completion and edit mode,
and that expansion state is transient.

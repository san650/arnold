  ...
  routines: [
    {
      ...
      exercises: [
        ...
        { id: 'd1e5', name: 'Dumbbell Tricep Extensions', sets: 3, reps: '8-12', weight: null, video: 'https://youtu.be/BW15DLXmvUY', notes: '' },
      ],
    },
    {
      id: 'day2',
      ...
      exercises: [
        { id: 'd2e1', name: 'Barbell Squats', sets: 3, reps: '8-12', weight: null, video: 'https://youtu.be/S9iWwaqbD3Q', notes: '' },
        { id: 'd2e2', name: 'Bulgarian Split Squats', sets: 3, reps: '8-12 por pierna', weight: null, video: 'https://youtu.be/9p5e2BSvoLs', notes: '' },
        { id: 'd2e3', name: 'Leg Press', sets: 3, reps: '8-12', weight: null, video: 'https://youtu.be/px3fnV8dCl0', notes: '' },
